...
define("admin/main",function(require){"use strict";function a(a){return a&&a.__esModule?a:{"default":a}}var c=require("site/admin/App.vue"),v=a(c),h=require("node_modules/vue-layer/dist/vue-layer"),g=a(h),b=require("pizzatools"),k=a(b);Vue.use(VueRouter),Vue.prototype.$tools=k["default"],Vue.prototype.$layer=g["default"](Vue);{var w=function(a){return require(["site/admin/pages/tree/tree.vue"],a)},V=function(a){return require(["site/admin/pages/tree/edit.vue"],a)},y=function(a){return require(["site/admin/pages/news/news.vue"],a)},$=function(a){return require(["site/admin/pages/news/edit.vue"],a)},_=function(a){return require(["site/admin/pages/block/block.vue"],a)},z=function(a){return require(["site/admin/pages/block/edit.vue"],a)},R=function(a){return require(["site/admin/pages/guestbook/guestbook.vue"],a)},A=function(a){return require(["site/admin/pages/user/user.vue"],a)},M=function(a){return require(["site/admin/pages/user/edit.vue"],a)},j=[{path:"/",component:require("site/admin/pages/index.vue")},{path:"/news",component:y},{path:"/news/edit/:id",component:$},{path:"/news/create",component:$},{path:"/block",component:_},{path:"/block/edit/:id",component:z},{path:"/block/edit",component:z},{path:"/guestbook",component:R},{path:"/user",component:A},{path:"/user/edit/:id",component:M},{path:"/user/edit",component:M},{path:"/tree",component:w},{path:"/tree/add/:id",component:V},{path:"/tree/edit/:id",component:V}],B=new VueRouter({routes:j});new Vue({render:function(a){return a(v["default"])},router:B}).$mount("#app")}});
