...
define("node_modules/uuid/lib/rng-browser",function(require,exports,module){var a,w="undefined"!=typeof w?w:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{},y=w.crypto||w.msCrypto;if(y&&y.getRandomValues){var c=new Uint8Array(16);a=function(){return y.getRandomValues(c),c}}if(!a){var v=new Array(16);a=function(){for(var r,i=0;16>i;i++)0===(3&i)&&(r=4294967296*Math.random()),v[i]=r>>>((3&i)<<3)&255;return v}}module.exports=a});
define("node_modules/uuid/lib/bytesToUuid",function(require,exports,module){function b(b,c){var i=c||0,v=a;return v[b[i++]]+v[b[i++]]+v[b[i++]]+v[b[i++]]+"-"+v[b[i++]]+v[b[i++]]+"-"+v[b[i++]]+v[b[i++]]+"-"+v[b[i++]]+v[b[i++]]+"-"+v[b[i++]]+v[b[i++]]+v[b[i++]]+v[b[i++]]+v[b[i++]]+v[b[i++]]}for(var a=[],i=0;256>i;++i)a[i]=(i+256).toString(16).substr(1);module.exports=b});
define("node_modules/uuid/v4",function(require,exports,module){function a(a,y,g){var i=y&&g||0;"string"==typeof a&&(y="binary"==a?new Array(16):null,a=null),a=a||{};var _=a.random||(a.rng||b)();if(_[6]=15&_[6]|64,_[8]=63&_[8]|128,y)for(var c=0;16>c;++c)y[i+c]=_[c];return y||v(_)}var b=require("node_modules/uuid/lib/rng-browser"),v=require("node_modules/uuid/lib/bytesToUuid");module.exports=a});
